...
contract Ownable {
    ...
    modifier onlyOwner() {
        require (msg.sender == _owner, "msg.sender ist not the contract owner!");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "No valid newOwner address has been provided!");
        _owner = newOwner;
        emit ContractOwnerShipTransferred(_owner);
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(tokenOwner != to, "The given address already owns this token!");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == tokenOwner
            || isApprovedForAll(tokenOwner, msg.sender), "This is only allowed if called by token owner or isApprovedForAll is true");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "Given to address is invalid!");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "From address is not owner of this token!");

        // TODO: require token is being transfered to valid address
        require(to != address(0), "The target address is invalid!");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(uint tokenId) internal {
        require(_exists(tokenId), "The token with the given ID does not exist!");
...
contract CustomERC721Token is ERC721Metadata("Real Estate","REA","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
